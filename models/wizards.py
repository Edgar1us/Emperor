...
class create_battle(models.TransientModel):
    ...
    defend = fields.Many2one('emperor.kingdom', domain="[('template', '=', False),('owner','!=','attacker')]")
    ...
    def create_battle(self):
        b = self.env['emperor.battle'].create({
